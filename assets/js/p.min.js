let answer = { first_q: "", second_q: "", third_q: "", fourth_q: "" };
...
jQuery(document).ready(function () {
  ...
  $(document).ready(function () {
    $(".bq1").click(function (e) {
      answer.first_q = e.currentTarget.children[0].children[0].textContent;
      $("#q1").fadeOut("slow", function () {
        $("#q2").fadeIn("slow");
      });
    }),
      $(".bq2").click(function (e) {
        answer.second_q = e.currentTarget.children[0].children[0].textContent;
        $("#q2").fadeOut("slow", function () {
          $("#q3").fadeIn("slow");
        });
      }),
      $(".bq3").click(function (e) {
        answer.third_q = e.currentTarget.children[0].children[0].textContent;
        $("#q3").fadeOut("slow", function () {
          $("#q4").fadeIn("slow");
        });
      }),
      $(".bq4").click(function (e) {
        answer.fourth_q = e.currentTarget.children[0].children[0].textContent;
        scrollTo("id1"),
